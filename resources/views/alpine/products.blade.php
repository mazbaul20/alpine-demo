...
<body class="bg-gray-100" x-data="data">
    ...
    <div class="container mx-auto p-4">
        ...
        <form @submit.prevent="saveProduct()" id="createProductForm" class="mb-4 bg-white p-4 rounded shadow">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <input type="text" x-model="quentity" id="quentity" placeholder="quentity" class="border p-2 rounded" required>
        ...
        <table class="w-full bg-white rounded shadow">
            <thead class="bg-gray-200">
                <tr>
                    ...
                    <th class="p-2 text-left">quentity</th>
            ...
            <tbody id="productsList">
                ...
                <template x-for="product in products" :key="product.id">
                    <tr>
                        ...
                        <td class="p-2" x-text="product.quentity"></td>
        ...
        <div x-show="open" id="editProductModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center" style="display: none;">
            <diahv class="bg-white p-4 rounded shadow w-1/3">
                ...
                <form @submit.prevent id="editProductForm">
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium mb-1">quentity</label>
                        <input x-model="editProduct.quentity" type="text" id="editquentity" class="border p-2 rounded w-full" required>
                    </div>
                    <div class="mb-4">
    ...
    <script>
        const data = {
            ...
            open:false,
            saveProduct() {
                // console.log(this.name, this.quentity, this.price);
                axios.post('/products', {
                    name: this.name,
